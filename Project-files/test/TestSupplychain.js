...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function processItem() that allows a farmer to process coffee", async() => {
        ...
        //await supplyChain.addFarmer(originFarmerID, {from: ownerID}) //option to set sender of add operation to contract owner
        ...
        await supplyChain.processItem(upc, { from: originFarmerID}) //alternative?
        ...
        // Verify the result set
        assert.equal(resultBufferTwo[5], 1, 'Error: Invalid item State') //compact-alternative
        assert.equal(eventEmitted, true, 'Invalid event emitted') //compact-alternative
    ...
    it("Testing smart contract function shipItem() that allows a distributor to ship coffee", async() => {
        ...
        // Mark an item as Sold by calling function buyItem() //incorrect boilerplate
