...
contract SupplyChain is FarmerRole, DistributorRole, ConsumerRole, RetailerRole, Ownable {
  ...
  modifier checkValue(uint _upc) {
    ...
    address returnAddress = items[_upc].consumerID;
  ...
  //ADDED: modifier to enforce only farmer can call
  onlyFarmer()
  {
  ...
  function buyItem(uint _upc) public payable 
    ...
    checkValue (_upc)
    //ADDED: modifier to enforce only distributor can call
    onlyDistributor()
    {
    ...
    // address payable farmerAddress = address(uint160(items[_upc].originFarmerID)); //for later versions of solidity
    // farmerAddress.transfer(items[_upc].productPrice); //for later versions of solidity
  ...
  function receiveItem(uint _upc) public 
    ...
    //ADDED: modifier to enforce only retailer can call
    onlyRetailer()
    {
